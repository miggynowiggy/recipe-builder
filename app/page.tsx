            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl">
                  Take a photo of your ingredients or enter them manually to discover delicious recipes you can make
                  right now.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500">
                    Take a photo of your ingredients and let our AI identify them for you.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500">
                    Discover recipes that match your available ingredients with detailed instructions.
                  </p>
                </div>
              </div>
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-500">Bookmark recipes you love to easily find them later.</p>
                </div>
              </div>
            </div>
          </div>
